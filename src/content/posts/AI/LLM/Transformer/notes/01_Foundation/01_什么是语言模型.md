...
> - **瓶颈**：[梯度消失](../../Machine-learning/notes/09_Sequence_Models/02_梯度消失与长短时记忆网络.md)导致"记不住太久以前"；**串行计算**无法利用 GPU 并行，训练慢
...
- [序列建模与循环神经网络](../../Machine-learning/notes/09_Sequence_Models/01_序列建模与循环神经网络.md) — RNN/LSTM 基础回顾
- [浅看 Transformer 架构](../../Machine-learning/notes/10_Attention_and_Transformer/02_浅看Transformer架构.md) — ML 系列中的 Transformer 概览
