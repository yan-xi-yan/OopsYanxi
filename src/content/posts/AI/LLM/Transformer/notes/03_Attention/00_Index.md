...
| 笔记 | 要点 |
|------|------|
| [理解 Self Attention](./01_理解Self Attention.md) | Q/K/V 直觉类比，与 RNN/CNN 的对比，为什么能捕捉长程依赖 |
| [Self Attention 计算](./02_Self Attention计算.md) | Scaled Dot-Product 公式推导，数值实例，代码实现 |
